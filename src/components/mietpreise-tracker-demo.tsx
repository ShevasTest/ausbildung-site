...
const COPY: Record<LocaleKey, DemoCopy> = {
  de: {
    ...
    calculator: {
      ...
      subtitle:
        "Faustregel-Rechner für Junior-/Entry-Level: Warmmiete sollte je nach Sicherheitsniveau 30–40 % des Nettohaushaltseinkommens ausmachen.",
      cityLabel: "Stadt",
  ...
  en: {
    ...
    calculator: {
      ...
      subtitle:
        "Rule-of-thumb calculator for junior/entry level: warm rent should usually stay between 30–40% of net household income.",
      cityLabel: "City",
