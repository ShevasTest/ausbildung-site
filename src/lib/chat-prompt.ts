...
const PORTFOLIO_FACTS = [
  ...
  "- Oleksandr Shevchenko is open to junior roles in data maintenance, digitalisation and automation — Landshut/Munich area or remote, part-time also possible.",
  ...
  "- His strongest area is careful, verifiable work with data: keeping records clean and current, finding inconsistencies, and replacing repetitive manual steps with automation he checks himself.",
