  ...
  const structuredData = toJsonLd([
    ...
    },
    {
      ...
      jobTitle: isDe
        ...
        : "Aspiring Fachinformatiker for Application Development",
      knowsAbout: [
  ...
  return (
    <main>
      ...
      <section id="hero" className="portfolio-shell hero-section scroll-mt-24">
        <div className="hero-copy hero-enter">
          <p className="portfolio-eyebrow">
            {isDe ? "Ausbildungssuche · deutschlandweit · Start 2026" : "Ausbildung search · Germany-wide · 2026 start"}
          </p>
          ...
          <p className="hero-lead">
            {isDe
              ? "Seit rund vier Jahren setze ich täglich eigene Software-, Skript- und Automatisierungsprojekte mit KI um. Für 2026 suche ich eine Ausbildung, in der ich diese Umsetzungskraft mit fundierten technischen Grundlagen und professioneller Teamarbeit verbinde."
              : "For around four years, I have built personal software, scripting and automation projects with AI every day. For 2026, I am looking for an Ausbildung that combines this delivery ability with sound technical foundations and professional teamwork."}
          </p>
      ...
      <section id="resume" className="portfolio-section portfolio-section-muted render-deferred scroll-mt-24">
        <div className="portfolio-shell split-section">
          <div className="section-intro section-intro-sticky" data-reveal>
            <p className="portfolio-eyebrow">{isDe ? "Erfahrung & Entwicklung" : "Experience & growth"}</p>
            <h2>{isDe ? "Mein Weg in die Entwicklung." : "My path into development."}</h2>
            <p>
              {isDe
              ? "Vier Jahre tägliche Umsetzungspraxis — mit klar benannten Stärken, ehrlichen Wissensgrenzen und dem Ziel, professionell zu wachsen."
              : "Four years of daily delivery practice — with clearly stated strengths, honest knowledge boundaries and a goal to grow professionally."}
            </p>
          </div>
      ...
      <section id="contact" className="portfolio-shell contact-section scroll-mt-24" data-reveal>
        ...
        <p>
          {isDe
            ? "Ich suche einen Ausbildungsplatz für 2026 und freue mich auch über Praktikum, Probearbeit oder ein erstes Kennenlerngespräch."
            : "I am looking for an Ausbildung position in 2026 and I am also open to internships, trial work or an introductory call."}
        </p>
